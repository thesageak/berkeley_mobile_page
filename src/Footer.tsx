...
export default function Footer() {
    return (
        <footer className = "flex flex-row justify-center items-center gap-60 -translate-y-10">
            <Link to = "/privacy" className = "cursor-pointer hover:underline">Privacy</Link>
            <Link to = "/release" className = "cursor-pointer hover:underline">Release Notes</Link>
