...
export default function HeroSection() {
  return (
    <div className="flex flex-col items-start justify-center h-full py-[64px] px-[32px]">
      <h1 className="font-bold text-[5rem] text-gray-900 leading-[1]">Berkeley</h1>
      <h1 className="font-bold text-[5rem] text-gray-900 leading-[1]">Mobile</h1>
      ...
      <a href="https://apps.apple.com/us/app/berkeley-mobile/id912243518">
        <img
          id="app-store"
          src={appStore}
          className="mt-8 w-40 transition-transform duration-300 ease-out hover:scale-105 hover:-translate-y-1"
        />
      </a>
    </div>
  );
